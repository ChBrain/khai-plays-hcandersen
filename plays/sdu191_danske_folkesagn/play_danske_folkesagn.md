...
- [Vaesen](position_vaesen.md)
- [Sagn](piece_sagn.md)
- [Vand](piece_vand.md)
- [Danmark](place_danmark.md)
- [Aaen](place_aaen.md)
- [Fortaelling](process_fortaelling.md)
- [Overlevering](process_overlevering.md)
- [Bevaring](plan_bevaring.md)
- [Historisk](pitch_historisk.md)

## Triggers

- [plot_sagnene.md](plot_sagnene.md) når fortælleren vandrer ud i det danske landskab om aftenen.
- [plot_aaen.md](plot_aaen.md) når fortælleren når åbredden og hører åens rislen.

## Stakes

Kampen står mellem den nye tids glemsel, der truer sagnene, og fortællerens indsats for at bevare den mundtlige kulturarv.
