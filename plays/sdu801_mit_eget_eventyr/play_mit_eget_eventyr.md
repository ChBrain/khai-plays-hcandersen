...
# Play: Mit eget Eventyr uden Digtning
...
- [WilhelmPersona](persona_wilhelm.md)
- [ModerPersona](persona_moder.md)
- [SpaakonePersona](persona_spaakone.md)
- [SiboniPersona](persona_siboni.md)
- [WeysePersona](persona_weyse.md)
- [BaggesenPersona](persona_baggesen.md)
- [CollinPersona](persona_collin.md)
...
- [SangmesterPosition](position_sangmester.md)
- [KomponistPosition](position_komponist.md)
- [PoetPosition](position_poet.md)
- [FormynderPosition](position_formynder.md)
...
- [IndsamlingPiece](piece_indsamling.md)
...
- [SiboniSalonPlace](place_sibonisalon.md)
...
- [AuditionProcess](process_audition.md)
- [PatronageProcess](process_indsamling.md)
...
- [plot_siboni_patron.md](plot_siboni_patron.md) udløses af Andersens uventede audition ved Sibonis middagsselskab, som sikrer ham hans første mæcenat.
...
- **Anerkendelse**: Hvorvidt den intellektuelle verden vil anerkende den fattige eventyrdigters folkelige geni.
- **Forsoning**: Overvindelsen af det akavede første møde og etableringen af et sandt broderskab mellem to litterære giganter.
- **Venskab**: Om forsoningen kan modnes til et varigt, hjerteligt venskab, hvor eventyrene endelig høres og ikke afvises.
