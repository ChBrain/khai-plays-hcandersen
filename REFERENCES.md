...
- [x] `collin-stipend` — Jonas Collin secures a royal rescript from Frederik VI placing him in Slagelse grammar school at the crown's expense; Collin becomes "a second father." **1822** (Ch. II/III). Counterpart: Jonas Collin / Frederik VI · Copenhagen. System: **patronage / class**.
- [x] `meisling-schooldays` — Rector Meisling's sustained humiliation across five years; the gift felt under threat. **1822–27** (Ch. III). Counterpart: Simon Meisling · Slagelse / Helsingør. System: **class / humiliation**.
